...
import { Link, Unlink, Activity, Loader2, MapPin, Calendar, XCircle } from "lucide-react";
...
export function GarminConnection() {
  ...
  const { activeJob, latestCompletedJob, calculateProgress, refreshJobs } = useGarminJobs();
  ...
  return (
    <Card className="card-gradient">
      <CardHeader>
        ...
        <CardDescription>
          Connect your Garmin account to automatically sync activities and training data
        </CardDescription>
      </CardHeader>
            ...
            <div className="p-4 rounded-lg bg-muted/20">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  ...
                  Automatic activity sync from Garmin
                </li>
                <li className="flex items-center gap-2">
